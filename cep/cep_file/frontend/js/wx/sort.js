...
function initials() {//公众号排序
    var SortList=$(".list-brand");
    var SortBox=$(".list-type");
    SortList.sort(asc_sort).appendTo('.list-type');//按首字母排序
    ...
    $.each(initials, function(index, value) {//添加首字母标签
        SortBox.append('<h1 class="sort_letter" id="'+ value +'">' + value + '</h1>');
    });
    if(num!=0){SortBox.append('<h1 class="sort_letter" id="default">#</h1>');}
